        ...
        <div className="w-[100vw] h-[100vh] flex">
            ...
            <div className="w-1/2 h-full flex flex-col py-4 px-2">
                ...
                <div className="h-15/16 flex justify-center items-center flex-col gap-6">
                    ...
                    <input className="h-8 p-5 outline-none border w-[24rem]" placeholder="Your Email" type="email" value={name} onChange={(e:ChangeEvent<HTMLInputElement>   )=>setName(e.target.value)}/>
